...
document.querySelector('.comoamazon').addEventListener('click', () =>{ document.querySelector('.envoltura').classList.toggle('noshow');document.querySelector('.falso').classList.toggle('show');});
document.querySelector('.falso').addEventListener('click', () =>{ document.querySelector('.envoltura').classList.toggle('noshow');document.querySelector('.falso').classList.toggle('show');});
